...
_GRAPH_EXPORTS = {
    ...
    "customer_support_graph": (
        "graph_src_v2.agents.customer_support_agent.graph",
        "graph",
    ),
    "deepagent_graph": ("graph_src_v2.agents.deepagent_agent.graph", "graph"),
    "personal_assistant_graph": (
        "graph_src_v2.agents.personal_assistant_agent.graph",
        "graph",
    ),
    "skills_sql_assistant_graph": (
        "graph_src_v2.agents.skills_sql_assistant_agent.graph",
        "graph",
    ),
}
