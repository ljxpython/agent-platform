...
- [x] `P2` 完成 chat 页面静态校验：`pnpm --dir apps/platform-web-vue typecheck`
- [x] `P2` 完成 chat 页面静态校验：`pnpm --dir apps/platform-web-vue lint`
- [x] `P2` 完成 chat 页面交互单测：`pnpm --dir apps/platform-web-vue exec vitest run src/modules/chat/components/ChatMessageList.spec.ts`
- [x] `P2` 完成 chat 页面构建校验：`pnpm --dir apps/platform-web-vue build`
