# Platform API V2 能力对账与收口清单

这份文档只解决一个问题：

> `apps/platform-api-v2` 已经做出来的后端能力，哪些已经被 `apps/platform-web-vue` 正式消费，哪些只是弱接入，哪些应该暂时收成 internal，哪些前端抽象应该继续清理。
